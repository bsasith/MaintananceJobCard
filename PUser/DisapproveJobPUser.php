...
elseif($ReportTo=='Both'){
    ...
    if ($con->query($insert) == TRUE) {
        ...
        header('location:.\DisapproveJobSucessPUser.php');
    ...
    <div class="container mt-5 ">
        ...
        <div class="mt-3">
            <form method="POST">
                ...
                <button type="submit" class="btn btn-success mt-3" name="disapprove"
                    onclick="return confirm('Are you sure?')">Disapprove Job</button>
