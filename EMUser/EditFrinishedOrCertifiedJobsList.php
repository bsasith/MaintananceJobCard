...
<body>
    ...
    <div class="container mt-5 ">
        ...
        <div class="mt-5">
            <h1>Edit Fineshed Job Comments</h1>
                ...
                <tbody>
                    ...
                    if ($workplace == 'Electrical') {
                        $sql = "SELECT * FROM `jobdatasheet`
                                 ...
                                 AND JobPostingDateTime >= DATE_SUB(NOW(), INTERVAL 10 DAY)
     ...
     <tr >
        ...
        <td>$JobStatusE</td>
        <td>$JobStatusM</td>
       <td><a href='..\EMUser\EditFrinishedOrCertifiedJobs.php?updateid=$id' class='btn btn-warning mt-1'>Edit</a>"; ?>
                    <?php
                        //echo $JobStatusM;
                        //echo $JobStatusE;
            ...
            <button type="back" class="btn btn-danger mt-3" name="back"><a
                    href="..\EMUser\indexEMUser.php" style="text-decoration:none;color:white">Back to
                    Main</a></button>
        </div>
    </div>
