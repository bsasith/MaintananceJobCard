...
<body >
    ...
    <div class="container mt-5 ">
        <div class="mt-5">
            <h1>Job Edited Successfully</h1>
            <button type="back" class="btn btn-success mt-3 mx-2" name="back" ><a href=".\EditFrinishedOrCertifiedJobsList.php" style="text-decoration:none;color:white">Back to List</a></button>
            <button type="back" class="btn btn-danger mt-3" name="back" ><a href="..\EMUser\indexEMUser.php" style="text-decoration:none;color:white">Back to Main</a></button>
             <!-- <?php
